    ...
    <>
      {isAllFilter && (
        <div className="wrapper">
          <div className="card">
            <img className="img_card" alt="Syker" src={syker} />
            <div className="info">
              <h1 className="h1_card">Syker</h1>
              <p className="p_card">
                Syker is a place to buy affordable high quality trendy fashion
                clothing lineup, sold in Lebanon . Built with MERN Stack.
              </p>
              <button
                className="button_card"
                onClick={() =>
                  (window.location.href = "https://syker-codi.herokuapp.com")
                }
              >
                Read More
              </button>
          ...
          <div className="card">
            <img className="img_card" alt="LMS" src={lms} />
            <div className="info">
              <h1 className="h1_card">LMS</h1>
              <p className="p_card">
                This platform provides teachers to add classes and sections for
                their students
              </p>
              <button
                onClick={() => {
          ...
          <div className="card">
            <img className="img_card" alt="Siverr" src={siverr} />
            <div className="info">
              <h1 className="h1_card">Siverr</h1>
              <p className="p_card">
                Siverr is a freelance marketplace. You create a client or
                sellers account and create a listing for your services or vice
                versa.You can additionally create your own category and
                subcategory.Siverr is built with React/Laravel/Pusher/MYSQL
              </p>
              <button
                onClick={() => {
                  SetButtonPopSiverr(true);
                }}
                className="button_card"
              >
                Read More
          ...
          <div className="card">
            <img className="img_card" alt="Sarelle-jewelry" src={wordpress} />
            <div className="info">
              <h1 className="h1_card">Sarelle Jewelry</h1>
              <p className="p_card">
                Sarelle jewelry is a platform to buy custom Lebanese Handmade
                gold in Sweden{" "}
              </p>
              <button
                className="button_card"
                onClick={() =>
                  (window.location.href =
                    "http://sarelle-jewelry.infinityfreeapp.com/?i=1#1634029604611-0c3d59e1-b80c")
                }
              >
                Read More
              </button>
